...
class Generator(nn.Module):
    ...
    def setup(self):
        ...
        # pre conv
        self.conv_pre = nn.Conv(features=self.hp.gen.upsample_initial_channel, kernel_size=[7], strides=1, padding=3)
        # nsf
        ...
        # post conv
        self.conv_post = nn.Conv(features=1, kernel_size=[7], strides=1, padding=3, use_bias=False,kernel_init=normal_init(0.01))
