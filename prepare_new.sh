...
#python prepare/cut_f0_padded.py -w dataset/waves-16k/ -o dataset/pitch
python prepare/gen_hubert.py -w dataset/waves-16k/ -o dataset/hubert
#python prepare/cut_hubert_padded.py -w dataset/waves-16k/ -o dataset/hubert
python prepare/gen_spec.py -w dataset/waves-32k/ -o dataset/spec
#python prepare/cut_spec_padded.py -w dataset/waves-32k/ -o dataset/spec
